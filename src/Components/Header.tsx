...
const Header = () => {
    ...
    <>
      ...
      {registerOpen && (
        <Register setOpen={setRegisterOpen} setLoginOpen={setLoginOpen} />
      )}
      {loginOpen && (
        <Login setOpen={setLoginOpen} setRegisterOpen={setRegisterOpen} />
      )}
        ...
        <div className="xl:bg-[#6C531D] bg-[#FFB71B]">
          <div className=" flex h-full justify-end space-x-5">
            ...
            >
              ...
              <div className="hidden xl:block">Favqulodda vaziyatlar</div>
            </div>
            {/* LOGIN */}
            <div
            ...
            >
              ...
              <div className="hidden xl:block">Kirish</div>
            </div>
          </div>
        </div>
